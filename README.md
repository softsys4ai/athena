...
[Machine learning systems](https://pooyanjamshidi.github.io/mls/) have achieved impressive success in a wide range of domains like computer vision and natural langurage processing. Their vulnerability to adversarial examples can lead to a series of consequences, especially in security-critical tasks. For example, an object detector on a self-driving vehicle may incorrectly recognize [an stop sign as a speed limit](https://spectrum.ieee.org/cars-that-think/transportation/sensors/slight-street-sign-modifications-can-fool-machine-learning-algorithms). 
...
<p align="center">
    <img width="450px" height="auto" src="www/eval_wb_greedy.png">
    <img width="450px" height="auto" src="www/samples_cifar100_wb.png">
</p>
<p align="center">
    <img width="450px" height="auto" src="www/eval_wb_cost.png">
    <img width="450px" height="auto" src="www/eval_wb_detector.png">
</p>
